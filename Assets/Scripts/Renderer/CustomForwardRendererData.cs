...
using UnityEngine.Scripting.APIUpdating;
    ...
    public class CustomForwardRendererData : ScriptableRendererData
    {
        ...
        internal class CustomCreateForwardRendererAsset : EndNameEditAction
        {
        ...
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CustomCreateForwardRendererAsset>(), "CustomForwardRendererData.asset", null, null);
        }
#endif
